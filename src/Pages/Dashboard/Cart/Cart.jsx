    ...
    <div className="">
      ...
      <div className="card bg-white  rounded-xs w-9/12 py-8 mx-auto">
        <div className="flex justify-around items-center">
          ...
          {
            !cart.length ? <button disabled className="btn btn-primary bg-[#fb923c] border-none text-white font-Cinzel">
            Pay
                ...
                <tr key={item._id} className="hover:bg-gray-100">
                  ...
                  <td className="px-6 py-4">
                    <button
                      ...
                      className="w-10 h-10  grid items-center justify-center cursor-pointer text-red-500 ml-10"
                    >
